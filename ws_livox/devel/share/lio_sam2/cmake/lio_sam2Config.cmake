...
if(lio_sam2_CONFIG_INCLUDED)
  return()
endif()
set(lio_sam2_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lio_sam2_SOURCE_PREFIX /home/magnarecta/ws_livox/src/LIO-SAMOUTDOOR)
  set(lio_sam2_DEVEL_PREFIX /home/magnarecta/ws_livox/devel)
  set(lio_sam2_INSTALL_PREFIX "")
  set(lio_sam2_PREFIX ${lio_sam2_DEVEL_PREFIX})
else()
  set(lio_sam2_SOURCE_PREFIX "")
  set(lio_sam2_DEVEL_PREFIX "")
  set(lio_sam2_INSTALL_PREFIX /home/magnarecta/ws_livox/install)
  set(lio_sam2_PREFIX ${lio_sam2_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lio_sam2' is deprecated")
...
set(lio_sam2_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/magnarecta/ws_livox/devel/include;/home/magnarecta/ws_livox/src/LIO-SAMOUTDOOR/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(lio_sam2_INCLUDE_DIRS "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lio_sam2_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lio_sam2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lio_sam2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/magnarecta/ws_livox/src/LIO-SAMOUTDOOR/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lio_sam2_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lio_sam2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lio_sam2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lio_sam2_NUM_DUMMY_TARGETS)
      set(lio_sam2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lio_sam2::wrapped-linker-option${lio_sam2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lio_sam2_NUM_DUMMY_TARGETS "${lio_sam2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lio_sam2::wrapped-linker-option${lio_sam2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lio_sam2_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/magnarecta/ws_livox/devel/lib;/home/magnarecta/ws_livox/devel/lib;/home/magnarecta/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lio_sam2_LIBRARY_DIRS ${lib_path})
      list(APPEND lio_sam2_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lio_sam2'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lio_sam2_LIBRARIES ${lib})
    endif()
  endif()
...
set(lio_sam2_EXPORTED_TARGETS "lio_sam2_generate_messages_cpp;lio_sam2_generate_messages_eus;lio_sam2_generate_messages_lisp;lio_sam2_generate_messages_nodejs;lio_sam2_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lio_sam2_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 lio_sam2_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lio_sam2_dep}_FOUND)
      find_package(${lio_sam2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lio_sam2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lio_sam2_INCLUDE_DIRS ${${lio_sam2_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lio_sam2_LIBRARIES ${lio_sam2_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lio_sam2_dep}_LIBRARIES})
  _list_append_deduplicate(lio_sam2_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lio_sam2_LIBRARIES ${lio_sam2_LIBRARIES})

  _list_append_unique(lio_sam2_LIBRARY_DIRS ${${lio_sam2_dep}_LIBRARY_DIRS})
  list(APPEND lio_sam2_EXPORTED_TARGETS ${${lio_sam2_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lio_sam2-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lio_sam2_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
