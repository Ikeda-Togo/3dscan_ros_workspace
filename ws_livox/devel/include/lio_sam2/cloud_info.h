// Generated by gencpp from file lio_sam2/cloud_info.msg
// DO NOT EDIT!


#ifndef LIO_SAM2_MESSAGE_CLOUD_INFO_H
#define LIO_SAM2_MESSAGE_CLOUD_INFO_H
...
struct cloud_info_
{
  ...
  typedef boost::shared_ptr< ::lio_sam2::cloud_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lio_sam2::cloud_info_<ContainerAllocator> const> ConstPtr;

}; // struct cloud_info_

typedef ::lio_sam2::cloud_info_<std::allocator<void> > cloud_info;

typedef boost::shared_ptr< ::lio_sam2::cloud_info > cloud_infoPtr;
typedef boost::shared_ptr< ::lio_sam2::cloud_info const> cloud_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lio_sam2::cloud_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lio_sam2::cloud_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::lio_sam2::cloud_info_<ContainerAllocator1> & lhs, const ::lio_sam2::cloud_info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::lio_sam2::cloud_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lio_sam2::cloud_info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lio_sam2::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lio_sam2::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lio_sam2::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lio_sam2::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lio_sam2::cloud_info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::lio_sam2::cloud_info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x50b728f6fcea6789ULL;
  static const uint64_t static_value2 = 0xaf5feea0b14f80feULL;
};

template<class ContainerAllocator>
struct DataType< ::lio_sam2::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::lio_sam2::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Cloud Info\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lio_sam2::cloud_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lio_sam2::cloud_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lio_sam2::cloud_info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // LIO_SAM2_MESSAGE_CLOUD_INFO_H
